<template>
  <div id="app" class="container mt-5">
    <div id="nav">
      ...
      <router-link :to="{name: 'ingreso'}" v-if="!existeUsuario" class="btn btn-primary mx-2">Ingreso</router-link> 
      <a @click="cerrarSession" v-if="existeUsuario" class="btn btn-danger mx-2">Cerrar Session</a> 
    </div>
    <router-view/>
  </div>
</template>
